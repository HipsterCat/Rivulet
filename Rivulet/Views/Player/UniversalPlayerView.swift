...
#Preview {
    UniversalPlayerView(
        metadata: PlexMetadata(
//            ratingKey: <#T##String?#>, key: <#T##String?#>, guid: <#T##String?#>, type: <#T##String?#>, title: <#T##String?#>, originalTitle: <#T##String?#>, studio: <#T##String?#>, contentRating: <#T##String?#>, summary: <#T##String?#>, tagline: <#T##String?#>, year: <#T##Int?#>, rating: <#T##Double?#>, audienceRating: <#T##Double?#>, ratingImage: <#T##String?#>, audienceRatingImage: <#T##String?#>, thumb: <#T##String?#>, art: <#T##String?#>, banner: <#T##String?#>, Genre: <#T##[PlexTag]?#>, Collection: <#T##[PlexTag]?#>, duration: <#T##Int?#>, originallyAvailableAt: <#T##String?#>, addedAt: <#T##Int?#>, updatedAt: <#T##Int?#>, librarySectionTitle: <#T##String?#>, librarySectionID: <#T##Int?#>, librarySectionKey: <#T##String?#>, parentRatingKey: <#T##String?#>, parentGuid: <#T##String?#>, parentKey: <#T##String?#>, parentTitle: <#T##String?#>, parentIndex: <#T##Int?#>, parentThumb: <#T##String?#>, grandparentRatingKey: <#T##String?#>, grandparentGuid: <#T##String?#>, grandparentKey: <#T##String?#>, grandparentTitle: <#T##String?#>, grandparentThumb: <#T##String?#>, grandparentArt: <#T##String?#>, grandparentTheme: <#T##String?#>, index: <#T##Int?#>, leafCount: <#T##Int?#>, viewedLeafCount: <#T##Int?#>, childCount: <#T##Int?#>, viewCount: <#T##Int?#>, viewOffset: <#T##Int?#>, lastViewedAt: <#T##Int?#>, skipCount: <#T##Int?#>, userRating: <#T##Double?#>, lastRatedAt: <#T##Int?#>, Media: <#T##[PlexMedia]?#>, Role: <#T##[PlexRole]?#>, Director: <#T##[PlexCrewMember]?#>, Writer: <#T##[PlexCrewMember]?#>, Extras: <#T##PlexExtrasContainer?#>, Marker: <#T##[PlexMarker]?#>, OnDeck: <#T##PlexOnDeck?#>, hasPremiumPrimaryExtra: <#T##String?#>, primaryExtraKey: <#T##String?#>
            ratingKey: "123",
            type: "movie",
            title: "Sample Movie",
            year: 2024,
