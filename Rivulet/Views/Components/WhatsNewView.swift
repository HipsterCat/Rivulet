...
struct WhatsNewView: View {
    ...
    static let changelogs: [(version: String, features: [String])] = [
        ("1.0.4 (70)", [ // confirm build number at release
            ...
            "Updated AetherEngine to 5.20.2. Fixes titles that never finished playing at the very end, resuming near the end of a movie getting stuck on Loading, Dolby Vision being dropped when you resume close to the end, and a crash after several minutes of playback on fast connections",
